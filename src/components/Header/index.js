...
class Header extends Component{
        ...
        return (
            ...
            <div className="hrcloud-d-container">
                <div className="hrcloud-d-card-container">
                    ...
                    <p className="hrcloud-d-desc1">Manage and automate the employee lifecycle</p>
                    <button className="hrcloud-d-button">Learn More</button>
                    <Link to="hrlogin">
                        <button type="button" className="hr-login-button">Login</button>
                    </Link>
                    <Link to="employedb">
                        <button type="button" className="hr-login-button1">Employee Attendance</button>
                    </Link>
                </div>
                <div className="hrcloud-d-card-container">
                    ...
                    <div className="hrcloud-d-item-container1">
                        ...
                        <div className="hrcloud-d-name-container">
                            ...
                            <p className="hrcloud-d-name-desc">Recruit and Developers Talent</p>
                        </div> 
                    </div>
                    </Link>
                    <div className="hrcloud-d-item-container1">
                    ...
                    <div className="hrcloud-d-item-container1">
                        ...
                        <div className="hrcloud-d-name-container">
                            ...
                            <p className="hrcloud-d-name-desc">Large group of benefits & HR</p>
                        </div> 
                    </div>
                    ...
                    <div className="hrcloud-d-item-container1">
                        ...
                        <div className="hrcloud-d-name-container">
                            <h1 className="hrcloud-d-name">Benefits</h1>
                            <p className="hrcloud-d-name-desc">Manage workforce benefits</p>
                        </div> 
                    </div>
                </div>
                <div className="hrcloud-d-card-container">
                    ...
                    <div className="hrcloud-d-item-container1">
                        ...
                        <div className="hrcloud-d-name-container">
                            <h1 className="hrcloud-d-name">Performance Management</h1>
                            <p className="hrcloud-d-name-desc">Build High Performance teams</p>
                        </div> 
                    </div>
                    ...
                    <div className="hrcloud-d-item-container1">
                        ...
                        <div className="hrcloud-d-name-container">
                            ...
                            <p className="hrcloud-d-name-desc">Easy send Employee Serves</p>
                        </div> 
                    </div>
    ...
    iTCloudInformation = () => {
        return (
            ...
            <div className="hrcloud-d-card-container">
                ...
                <p className="hrcloud-d-desc1">Remotely secure and configure your company’s IT</p>
                <button className="hrcloud-d-button">Learn More</button>
            </div>
            <div className="hrcloud-d-card-container">
                <div className="hrcloud-d-item-container1">
                    ...
                    <div className="hrcloud-d-name-container">
                        ...
                        <p className="hrcloud-d-name-desc">Securely connect employs with your apps--Like Slack & Office365</p>
                    </div> 
                </div>
                ...
                <div className="hrcloud-d-item-container1">
                    ...
                    <div className="hrcloud-d-name-container">
                        <h1 className="hrcloud-d-name">Device Management</h1>
                        <p className="hrcloud-d-name-desc">Remotely setup Secure & Manage your Computers</p>
                    </div> 
                </div>
            </div>
        </div>
        ...
        return (
            ...
            <div className="hrcloud-d-card-container">
                <div className="hrcloud-d-item-container1">
                    ...
                    <div className="hrcloud-d-name-container">
                        <h1 className="hrcloud-d-name">Corporate Cards</h1>
    ...
    loginStatus = () => {
        return <button className="head-logout-button" type="button" onClick={this.onClickLogout}>Logout</button>
    }

    logoutStatus = () => {
        return <button className="head-login-button" type="button" onClick={this.onClickLogin}>Login</button>
    }
    ...
    return(
        <nav onClick={this.onClickNav} className="nav-main-container">
            <div className="nav-container">
                <div className="button-mobile-view-container">
                    <Link to="/">
                ...
                <ul className="nav-items">
                    ...
                    <li className="nav-item">
                        <button className="nav-button" onClick={this.onClickPrising} type="button">Prizing <GiBoxingGloveSurprise /></button> 
                    </li>
                    <li className="nav-item">
                        <button className="nav-button" onClick={this.onClickIntegrations} type="button">Integrations <MdIntegrationInstructions /></button> 
                    </li>
                    <li className="nav-item">
                        <button className="nav-button" onClick={this.onClickCustomars} type="button">Customers <AiOutlineCustomerService /></button> 
                    </li>
                    <li className="nav-item">
                ...
                <ul className="nav-items-mobile">
                    <li className="nav-item">
                        <button className="nav-button" onClick={this.onClickProducts} type="button"><MdOutlineProductionQuantityLimits /></button> 
                    </li>
                    <li className="nav-item">
                        <button className="nav-button" onClick={this.onClickPrising} type="button"><GiBoxingGloveSurprise /></button> 
                    </li>
                    <li className="nav-item">
                        <button className="nav-button" onClick={this.onClickIntegrations} type="button"><MdIntegrationInstructions /></button> 
                    </li>
                    <li className="nav-item">
                        <button className="nav-button" onClick={this.onClickCustomars} type="button"><AiOutlineCustomerService /></button> 
                    </li>
                    <li className="nav-item">
                        <button className="nav-button" onClick={this.onClickParternars} type="button"><HiMiniUserGroup/></button> 
                    </li>
                    <li className="nav-item">
                        <button className="nav-button" onClick={this.onClickResorces} type="button"><LuBarChartHorizontal/></button> 
                    </li>
                </ul>
